...
public class LoginUserCommandHandler : IRequestHandler<LoginUserCommand, JwtTokenPair>
{
    private readonly IAppDbContext _db;
    private readonly IJwtTokenService _jwtService;
    private readonly IPasswordHasher<Restaurant.Domain.Entities.Identity.Customer> _passwordHasher;

    public LoginUserCommandHandler(
        IAppDbContext db,
        IJwtTokenService jwtService,
        IPasswordHasher<Restaurant.Domain.Entities.Identity.Customer> passwordHasher
    )
    {
        _db = db;
