...
/// </summary>
public sealed class RestaurantBusinessRuleException : Exception
{
    public string Code { get; }

    public RestaurantBusinessRuleException(string code, string message)
        : base(message)
    {
        Code = code;
    }

    public RestaurantBusinessRuleException(string code, string message, Exception? innerException)
