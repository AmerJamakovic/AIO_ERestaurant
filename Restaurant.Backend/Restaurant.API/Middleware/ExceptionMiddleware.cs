    ...
    : IMiddleware
{
    public async Task InvokeAsync(HttpContext ctx, RequestDelegate next)
    {
        ...
        catch (Exception ex)
        {
            ...
            ctx.Response.StatusCode = ex switch
            {
                ...
                RestaurantConflictException => StatusCodes.Status409Conflict,
                RestaurantBusinessRuleException => StatusCodes.Status409Conflict,
    ...
    private static ErrorDto BuildErrorDto(Exception ex, bool isDev, string traceId)
    {
        ...
        switch (ex)
        {
            ...
            case RestaurantConflictException:
            case RestaurantBusinessRuleException:
                code = "entity.error";
                message = ex.Message;
                break;
